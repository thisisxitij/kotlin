...
typealias CachedCompilerArgumentByCompilation = MutableMap<String, CachedArgsInfo>
typealias KotlinSourceSetInfoByCompilation = MutableMap<String, KotlinSourceSetInfo?>
typealias CompilationDataByCompilation = MutableMap<String, GradleSourceSetData?>
...
var DataNode<ModuleData>.kotlinSourceSetInfoByCompilation: KotlinSourceSetInfoByCompilation
        by NotNullableCopyableDataNodeUserDataProperty(Key.create("MPP_SOURCE_SET_INFOS"), mutableMapOf())
