    ...
    companion object {
        ...
        private fun KotlinMPPGradleModel.populateSourceSetsWithCompilerArguments(
            ...
            for (compilation in compilations) {
                ...
                val kotlinSourceSetInfo = ideModule.kotlinSourceSetInfoByCompilation[compilation.name] ?: continue
                val cachedArgsInfo = ideModule.cachedCompilerArgumentsByCompilation[name] ?: continue
                ...
                with(CachedToRawCompilerArgumentsBucketConverter(mppMapper)) {
                    ...
                    if (compilation.platform == KotlinPlatform.JVM || compilation.platform == KotlinPlatform.ANDROID) {
                        ideModule.compilationDataByCompilation[compilation.name]?.targetCompatibility =
        ...
        private fun KotlinMPPGradleModel.collectCachedCompilerArgumentByCompilation(ideModule: DataNode<ModuleData>) =
            targets.flatMap { it.compilations }.associate { it.name to it.cachedArgsInfo }
            ...
            for (target in mppModel.targets) {
                ...
                for (compilation in target.compilations) {
                    ...
                    val kotlinSourceSet = createSourceSetInfo(
                        ...
                        mainModuleNode.cachedCompilerArgumentsByCompilation[compilation.name] = compilation.cachedArgsInfo
                        mainModuleNode.kotlinSourceSetInfoByCompilation[compilation.name] = it
                    } ?: continue
