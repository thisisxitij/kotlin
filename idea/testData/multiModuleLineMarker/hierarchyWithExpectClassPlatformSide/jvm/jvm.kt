...
actual open class <!LINE_MARKER("descr='Is subclassed by ExpectedChildChildJvm  Click or press ⌥⌘Bto navigate'"), LINE_MARKER("descr='Has declaration in common module'")!>ExpectedChild<!> : SimpleParent() {
