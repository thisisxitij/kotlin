expect sealed class <!LINE_MARKER("descr='Is subclassed by Sealed1 [common] Sealed1 in Sealed [jvm] Sealed2 [common] Sealed2 in Sealed [jvm]  Click or press ⌥⌘Bto navigate'"), LINE_MARKER("descr='Has actuals in JVM'")!>Sealed<!> {
